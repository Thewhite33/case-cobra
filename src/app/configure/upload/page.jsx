...
const page = () => {
    ...
    const { startUpload,isUploading } = useUploadThing('imageUploader', {
        onClientUploadComplete: (data) => {
            const configId = data[0].serverData;
            startTransition(() => {
    ...
    return (
        <div className={cn("relative h-full flex-1 my-16 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center", {
            ...
            <div className='relative flex flex-1 flex-col items-center justify-center w-full'>
                <Dropzone onDragEnter={() => setIsDragOver(true)} onDragLeave={() => setIsDragOver(false)} onDropRejected={onDropRejected} onDropAccepted={onDropAccepted} accept={{ "image/png": [".png"], "image/jpeg": [".jpeg"], "image/jpg": [".jpg"] }}>
