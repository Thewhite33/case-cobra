        ...
        <div className='bg-white'>
            <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
                <div className='max-w-xl'>
                    ...
                    <p className='mt-2 text-base text-zinc-500'>We've received your order and are noe processing it.</p>
                ...
                <div className='mt-10 border-t border-zinc-200'>
                    <div className='mt-10 flex flex-auto flex-col'>
                        ...
                        <p className='mt-2 text-sm text-zinc-600'>We at CaseCobra believe that a phone case doesn't only need to look good,but also last you for the years to come. We offer a 5-year print guarantee: If you case isn't of the highest quality,we'll replace it for free.</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className='grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm'>
                        ...
                        <div>
                            ...
                            <p className='mt-2 text-zinc-700'>Shiprocket</p>
                        </div>
                    </div>
                </div>
